...
<a href="https://www.linkedin.com/in/roshani-kamble-3a8b7b259">
  <img src="https://img.shields.io/badge/LinkedIn-0A0E14?style=for-the-badge&logo=linkedin&logoColor=2DD4BF&labelColor=0A0E14"/>
</a>
<a href="mailto:roshanikamble2002@gmail.com">
  <img src="https://img.shields.io/badge/Email-0A0E14?style=for-the-badge&logo=gmail&logoColor=FFB000&labelColor=0A0E14"/>
</a>
<a href="https://github.com/RoshaniBKamble">
  <img src="https://img.shields.io/badge/GitHub-0A0E14?style=for-the-badge&logo=github&logoColor=FFB000&labelColor=0A0E14"/>
</a>
...
OPEN_TO:  Frontend / Full Stack / Web3 / Blockchain / AI-ML Internships
```
...
**Databases & Tools**
<br/>
<img src="https://skillicons.dev/icons?i=postgres,mysql,sqlite,mongodb,git,github,gitlab,vscode,docker&theme=dark"/>

<br/>

<div align="center">

![Blockchain](https://img.shields.io/badge/Blockchain-0A0E14?style=flat-square&color=FFB000)
![Web3](https://img.shields.io/badge/Web3-0A0E14?style=flat-square&color=2DD4BF)
![Smart Contracts](https://img.shields.io/badge/Smart%20Contracts-0A0E14?style=flat-square&color=FFB000)
...
|---|---|---|
| Frontend Engineering (React, TypeScript, Tailwind) | Strong | Built responsive UI across multiple full-stack projects |
...
**What it does:** Provides conversational responses to legal queries, handling follow-up questions with context-aware answers rather than isolated Q&A.

**My contribution:** Built the Python Flask backend powered by the LLaMA 3.1 8B language model, and implemented conversational context handling for multi-turn interactions.

**Stack:** Python · Flask · LLaMA 3.1 · LLM · NLP
...
**What it does:** Uses RoBERTa, a transformer-based language model, to evaluate semantic similarity between resumes and job requirements, going beyond basic keyword matching.
...
**What it does:** Integrates computer-vision processing with a Django web application and a database workflow for managing images and face data.

**Stack:** Python · Django · Face Recognition · Computer Vision · Database
...
**Web3 & Blockchain Development Trainee** — MIT World Peace University
`Aug 2025 – Present · Pune, Maharashtra`
...
- Explored Ethereum, Solidity, EVM concepts, decentralized identity, DeFi, cryptographic hashing, and blockchain-based verification.
...
|---|---|
| 🏆 Winner — E.D.G.E. Mini Project, MIT-WPU | Developed a blockchain-based identity management solution for secure digital identity sharing |

<br/>

## `>_` education

<img src="https://img.shields.io/badge/M.Sc.%20Blockchain%20Technology-MIT--WPU%20%7C%202025--Present-0A0E14?style=for-the-badge&color=FFB000"/>
<br/>
<img src="https://img.shields.io/badge/BBA%20(Computer%20Applications)-SPPU%20%7C%202022--2025-0A0E14?style=for-the-badge&color=2DD4BF"/>
